    ...
    public partial class TaxiFareModel
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(new []{new InputOutputColumnPair(@"vendor_id", @"vendor_id"),new InputOutputColumnPair(@"payment_type", @"payment_type")})      
                                    ...
                                    .Append(mlContext.Regression.Trainers.FastForest(numberOfLeaves:52,minimumExampleCountPerLeaf:9,numberOfTrees:80,labelColumnName:@"fare_amount",featureColumnName:@"Features"));
